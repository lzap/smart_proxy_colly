...
module Proxy::Colly
  class Plugin < ::Proxy::Plugin
    ...
    default_settings :socket => '/var/run/collectd-unixsock', :timeout => 5
    ...
    after_activation do
      writer = Proxy::Colly::Writer.new(Proxy::Colly::Plugin.settings.socket, Socket.gethostname, Proxy::Colly::Plugin.settings.timeout)
